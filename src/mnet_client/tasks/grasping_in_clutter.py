...
class MnetSceneReplica:
    def __init__(self, package_path, cam_K, W, H, det, tag_id, corners, R_cw_cv, t_cw_cv):
        ...
        self.object_model_path = os.path.join(self.package_path, "src", "mnet_client", "assets", "grasping_in_clutter", "models")
        self.scene_path = os.path.join(self.package_path, "src", "mnet_client", "assets", "grasping_in_clutter", "scenes")
