...
```
rosrun mnet_client submission.py
```
...
The following steps should be identical to your experience with the [local test client](https://mnet-client.readthedocs.io/ros_1/local_test.html#client-usage). 
