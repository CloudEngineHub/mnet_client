...
ManipulationNet delivers standardized task setups for registered teams to enable comparable research across the globe. Please get registered [here](https://manipulation-net.org/registration.html).
