#! /usr/bin/env python3
# This is the connection test script for the ManipulationNet benchmark: manipulation-net.org
# It is designed to test the connection between the client and the server and check the qualification of the team
    ...
    def __init__(self):
        ...
        try:
            ...
            if os.path.exists(banner_file):
                ...
                rospy.logerr(f"Banner loading error: {banner_file}")
